...
//   どちらも0                          → まず本数を見る。12本に届くまでは題材の判定に使わない
//
// 3つ目を 2026-09-24 に書き換えた。同日の実測で、Rails トピックの個人記事のいいね
// 中央値は2、交差点（タイトルに生成AI 系の語）の個人40本でも2だった。ここの
// 「中央値3・10以上2本」は個人では上位10%の水準で、未達は「題材が外れている」の
// 証拠にならない。下回った本当の理由は本数（実績2本）のほうだった。
//
// 閾値は下げない。緩めるときは、緩めた事実と理由を残してから緩める。黙って下げると、
// 次に見たとき達成しているように見える。
//
//   npm run stats
